(() => {
  ...
  const gs=document.createElement('script');gs.src='./frontend/google-auth.js?v=20260912g';gs.defer=true;document.head.appendChild(gs);
})();
