(() => {
  ...
  function mountCreationAccount(){
    ...
    if(!document.getElementById('futuro-creation-core-loader')){const s=document.createElement('script');s.id='futuro-creation-core-loader';s.src='./frontend/creation-core.js?v=20260909d';document.body.appendChild(s)}
