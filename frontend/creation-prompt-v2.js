...
VISUAL STYLE — FUTUROLOGIO MUSEU LIMA:
Unique brand look: satirical editorial graphic-novel illustration mixed with a bright museum-diorama commercial.
...
The image must look like a well-lit collectible display card that POPS against a dark website. Do NOT make a dark, muddy or underexposed picture.
...
The word "FUTUROLOGIO™" must appear clearly as a lime-on-black museum plaque or illuminated logo on the product.
...
COLOR AND LIGHTING:
BRIGHT high-key museum lighting so every face, material and product detail is easy to see.
...
IMPORTANT:
No photoreal photography, anime, flat vector, stock, corporate ad, infographic, text-heavy poster, collage, multi-panel, excessive typography, dark underexposed image, or rainbow neon cyberpunk.
