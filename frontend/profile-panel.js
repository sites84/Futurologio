(() => {
  ...
  const style=document.createElement('style');style.textContent='.ft-real-profile{max-width:1080px;margin:16px auto;padding:0 20px}.ft-rp-card{background:var(--paper,#fffdf8);border:2px solid var(--ink,#171717);border-radius:18px;padding:18px;box-shadow:5px 5px 0 var(--ink,#171717)}.ft-rp-head{display:flex;gap:12px;align-items:center}.ft-rp-avatar{width:58px;height:58px;border:2px solid var(--ink,#171717);border-radius:50%;display:grid;place-items:center;background:var(--lime,#d8ff55);font-weight:950;font-size:20px}.ft-rp-head h2{margin:0 0 2px}.ft-rp-head b,.ft-rp-head small{display:block}.ft-rp-head small{color:var(--muted,#6f6b63);margin-top:3px}.ft-rp-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:7px;margin-top:15px}.ft-rp-grid div{border:1px solid var(--ink,#171717);border-radius:10px;padding:8px;text-align:center;background:white}.ft-rp-grid b,.ft-rp-grid small{display:block}.ft-rp-grid b{font-size:17px}.ft-rp-grid small{font-size:9px;color:var(--muted,#6f6b63)}.ft-rp-medal{margin-top:12px;font-weight:900}.ft-rp-badges{display:flex;flex-wrap:wrap;gap:6px;margin-top:9px}.ft-rp-badges span{border:1px solid var(--ink,#171717);border-radius:99px;padding:4px 7px;background:white;font-size:10px}.ft-rp-visitor,.ft-rp-loading{border:1.5px dashed var(--ink,#171717);border-radius:14px;padding:15px;background:var(--paper,#fffdf8)}.ft-rp-visitor b,.ft-rp-visitor span{display:block}.ft-rp-visitor span{font-size:12px;color:var(--muted,#6f6b63);margin-top:4px}@media(max-width:760px){.ft-real-profile{padding:0 12px}.ft-rp-grid{grid-template-columns:repeat(3,1fr)}}';document.head.appendChild(style);
