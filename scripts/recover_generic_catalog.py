...
def main():
    ...
    report={'catalog_records':len(catalog),'generic_detected':len(generic),'recovered':len(recovered),'recovered_ids':sorted(recovered_ids),'missing':missing,'source_records_scanned':len(sources),'repair_sql_statements':len(stmts)}
